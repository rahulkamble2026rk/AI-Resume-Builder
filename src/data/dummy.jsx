export default{
    ...
    ids:[
        ...
        },
        {
            id:2,
            name:'Leetcode',
             url: 'https://leetcode.com/u/Rahul23314/'
        },
        {
            id:3,
            name:'Codechef',
    ...
    projects: [
        {
            ...
            startDate: 'Jan 2022',
            endDate: 'Dec 2022',
            description: 'Developed an e-commerce website using React, Node.js, and MongoDB. Implemented user authentication, product listings, and a shopping cart.'
        },
        {
            id: 2,
            name: 'Mobile App',
            ...
            startDate: 'Mar 2021',
            endDate: 'Sep 2021',
            description: 'Built a mobile application using React Native. Features include real-time chat, notifications, and location-based services.'
        }
    ]
}